...
def setup_distributed(args):
    ...
    # Set your master address and port here
    master_addr = "127.0.0.1"  # Replace with the actual address of your master process
    master_port = "12345"      # Replace with the actual port number

    # Set the environment variables directly in your code
...
def ddp_init(args):
    ...
    if not args.distributed:
        print("Running on a single GPU without distributed training.")
        torch.cuda.set_device(args.gpu)
    ...
    # Deterministic settings for distributed
